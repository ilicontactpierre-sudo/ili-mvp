...
const SplitPreviewPane = forwardRef(function SplitPreviewPane({ storyData, onClose, topOffset = 89 }, ref) {
  ...
  return (
    <div
      ...
      style={{
        ...
        position: 'fixed',
        top: `${document.querySelector('[data-sticky="tabbar"]')?.offsetHeight + document.querySelector('[data-sticky="draftbar"]')?.offsetHeight || 89}px`,
        right: 0,
        height: `calc(100vh - ${document.querySelector('[data-sticky="tabbar"]')?.offsetHeight + document.querySelector('[data-sticky="draftbar"]')?.offsetHeight || 89}px)`,
        overflow: 'hidden',
        zIndex: 200,
...
function AdminPage() {
  ...
  const [storyMasterVolume, setStoryMasterVolume] = useState(1.0)
