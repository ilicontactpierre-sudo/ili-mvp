...
<tr><td style="padding:56px 48px 48px;font-family:'Roboto',Helvetica,Arial,sans-serif;color:${fg};">
  ...
  <!-- MESSAGE FOOTER -->
  <p style="font-size:10px;font-weight:400;letter-spacing:0.32em;text-transform:uppercase;color:${fgLow};text-align:center;line-height:2.2;margin:0 0 28px;">${footerMsg}</p>

  <!-- MINI REGLE -->
  <div style="width:28px;height:1px;background:${borderColor};margin:0 auto 28px;"></div>

  <!-- SIGNATURE -->
  <p style="font-size:10px;font-weight:600;letter-spacing:0.35em;text-transform:uppercase;color:${fgLow};text-align:center;line-height:2.2;margin:0 0 44px;">${signatureHtml}</p>
