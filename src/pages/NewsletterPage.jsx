...
<tr><td style="padding:56px 48px 48px;font-family:'Roboto',Helvetica,Arial,sans-serif;color:${fg};">
  ...
  <p style="text-align:center;font-size:11px;font-weight:200;letter-spacing:0.5em;text-transform:uppercase;color:${fgLow};margin:0 0 44px;">Lecture immersive</p>
