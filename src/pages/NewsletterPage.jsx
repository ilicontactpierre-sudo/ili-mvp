...
<tr><td style="padding:56px 48px 48px;font-family:'Roboto',Helvetica,Arial,sans-serif;color:${fg};">
  ...
  <tr><td style="padding:40px 40px 36px;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      ...
      <td align="right"><a href="${urlDisplay}" style="font-size:10px;font-weight:900;letter-spacing:0.28em;text-transform:uppercase;color:${fg};text-decoration:none;border-bottom:1px solid ${fgMid};padding-bottom:3px;">Lire avec ILi &rarr;</a></td>
    </tr></table>
