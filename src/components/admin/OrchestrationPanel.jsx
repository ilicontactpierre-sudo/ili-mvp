...
const CURATED_VOCABULARY = {
  'Ambiances naturelles': [
    ...
    'water', 'air', 'rock', 'stone', 'vegetation', 'aquatic', 'liquid',
    'flow', 'ice', 'farm', 'tree', 'foliage', 'flutter',
  ],
  'Ambiances urbaines': [
    ...
    'kitchen', 'drill', 'workshop', 'industrial', 'storage', 'park',
    'bathroom', 'hall', 'building', 'dining room',
  ],
  ...
  'Atmosphères & tensions': [
    ...
    'ambience', 'vintage', 'retro', 'hum', 'zombie', 'soviet', 'distorted',
    'undead', 'ghoul', 'skeleton', 'mummy', 'angry',
  ],
  ...
  'Guerre & violence': [
    ...
    'rumble', 'distant', 'war',
    'weapon', 'combat', 'attack', 'shot', 'gore', 'rifle', 'shooter',
    'strike', 'shoot', 'military', 'suppressed', 'crash & debris', 'debris',
  ],
  'Musique & instruments': [
    ...
    'instrument', 'stringed', 'music', 'band', 'synth', 'beat', 'drum',
    'string', 'horn',
  ],
  'Sons diégétiques — lieux & mobilité': [
    ...
    'engine', 'drive', 'motor', 'inside car', 'aircraft', 'idle', 'offride',
    'rail', 'plane', 'passby', 'driving', 'turbine', 'jet', 'accelerate',
    'trains', 'reverse', 'flyby', 'horn',
  ],
  'Sons diégétiques — actions humaines': [
    ...
    'press', 'vocal', 'slide', 'open', 'push', 'turn', 'shut', 'applauding',
    'run', 'cooking', 'spin', 'hand', 'closing', 'shout', 'female', 'male',
    'roll', 'opening', 'cheering', 'sliding', 'grab', 'mouth', 'cook',
    'falling', 'mumbling', 'whistle', 'eating', 'climb', 'groan', 'screaming',
  ],
  'Sons diégétiques — objets & matières': [
    ...
    'button', 'tools', 'metallic', 'friction', 'tool', 'cloth', 'scrape',
    'switch', 'ring', 'clatter', 'handle', 'squeak', 'rattling', 'appliance',
    'rustle', 'table', 'spring', 'leather', 'cassette', 'tableware', 'clank',
    'bag', 'grind', 'hydraulic', 'gear', 'wooden', 'packaging', 'crackle',
    'lift', 'latch', 'lid', 'radio', 'wobble', 'box', 'case', 'tap', 'camera',
    'ball', 'wheel', 'clang', 'chink', 'chains', 'plate', 'drawer', 'lever',
    'hiss', 'stick', 'tape', 'dishes', 'hifi', 'cutlery', 'mouse', 'clicking',
    'fabric', 'textile', 'kitchenware', 'clink', 'cabinet',
  ],
  'Transitions & effets': [
    'whoosh', 'sweep', 'transition', 'riser', 'stinger', 'shockwave',
    'snap', 'ping', 'beep', 'notification', 'surprising',
    'boom', 'swoosh', 'sting', 'hit', 'drop',
    'swooshes', 'alert', 'burst', 'feedback', 'bounce', 'swish',
  ],
  'Science-fiction & fantastique': [
    ...
    'electronic', 'humanoid', 'monster', 'device', 'digital', 'synthetic',
    'science', 'computers', 'electricity', 'future', 'console', 'pc',
    'synthesized', 'buzz',
  ],
  'Animaux': [
    'dog', 'cat', 'horse', 'bird', 'wolf', 'crow', 'owl', 'rat',
    'insects', 'fly', 'frog', 'whale', 'lion', 'animal',
    'buzz', 'animals', 'growl', 'screech', 'beast', 'roar', 'mouse', 'tail',
  ],
  'Loisirs & sport': [
    'sport', 'game', 'amusement', 'roller', 'coaster', 'ride', 'gaming',
    'fitness', 'gym', 'race', 'toy',
  ],
}
...
function buildExportPrompt(segments, soundLibrary) {
  ...
  lines.push('Avant de produire le JSON, relis ton propre plan et réponds honnêtement à quatre questions :')
  ...
  lines.push('- **Continuité sur l\'ensemble du texte** : parcours mentalement TOUTE la plage de segments, du premier au dernier, sans exception. Repère toute zone de plus de 10-12 segments consécutifs où seul le bed reste actif (aucune atmosphere, aucun diegetic, aucune musique). Une telle zone est presque toujours un oubli d\'attention, pas un vrai choix de sobriété — reviens-y et enrichis-la avant de continuer. Ce risque grandit avec la longueur du texte : sois particulièrement vigilant sur le tiers médian d\'un texte long, où l\'attention a tendance à se relâcher entre le début et la fin.')
  ...
  lines.push('- **La musique se mérite, elle n\'est pas un défaut.** Avant de créer un bloc music, demande-toi si le sound design seul (bed + atmosphere + diegetic) ne suffit pas déjà à porter la scène. Beaucoup de tension ou de mélancolie se joue très bien sans note de musique du tout — ne mets pas de musique juste parce qu\'une émotion existe.')
  lines.push('- Ce n\'est pas un objectif de quantité (ne compte pas les segments couverts) : c\'est un critère qualitatif, à juger scène par scène. Une scène de spectacle collectif, d\'ouverture, de clôture, ou de bascule émotionnelle nette peut légitimement appeler une musique à l\'image même sans tension dramatique — c\'est le rôle du compositeur de sublimer ou de contraster, pas seulement d\'accompagner les pics de tension. Ne saute pas ces occasions par réflexe de sobriété : juge chaque scène pour elle-même, pas par rapport à un quota global.')
  lines.push('')
