...
function buildFormattingExportPrompt(segments) {
  ...
  lines.push('Vérifie explicitement que le tiers médian du texte reçoit autant')
  lines.push('d\'attention que le début et la fin — sur un texte long, c\'est la zone où')
  lines.push('l\'on a tendance à relâcher l\'attention entre l\'ouverture et la clôture.')
  lines.push('Si le tiers médian est resté nu par oubli plutôt que par vrai choix de')
  lines.push('sobriété, reviens-y avant de produire le JSON.')
  lines.push('')
  lines.push('═══════════════════════════════════════════')
